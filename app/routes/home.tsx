...
function Hero() {
  ...
  return (
    <div className="pt-32 md:pt-20 xl:pt-40 bg-[url('/team2.jpg')] bg-cover bg-top bg-no-repeat bg-black/40 bg-blend-overlay w-full min-h-[90vh] md:h-[75vh] lg:h-screen text-white grid place-items-center">
